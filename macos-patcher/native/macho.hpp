// Adapted from the MIT-licensed cslol-tools Mach-O parser at
// LeagueToolkit/cslol-manager commit 23f230858bc2359ce279e07ed129d482fe3b00bf.
#pragma once
#include <cstddef>
#include <cstdint>
#include <cstring>
    ...
    inline void MachO::parse_data(data_t data, size_t size, std::uint32_t cputype) {
        ...
        for (auto i = 0u; i != nfat_arch; ++i) {
            ...
            if (arch_cputype == cputype) {
                if (arch_offset > size || arch_size > size - arch_offset) {
